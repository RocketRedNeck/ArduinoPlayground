...
void setup(void) 
{
  ...
  xWorkSize = xScreenSize - 55;
  yWorkSize = yScreenSize - 40*TEXT_SIZE;  
  ...
  PRINTLN(CLEARLN,0,"Pikagotchi!");
  PRINTLN(CLEARLN,1,"----------------------");
  PRINTLN(CLEARLN,2,"Line 2");
  PRINTLN(CLEARLN,3,"Line 3");
  
  
  if (!SD.begin(SD_CS)) 
  {
    ERRPRINTLN(CLEARLN,0,"SD failed!");
  }
}
