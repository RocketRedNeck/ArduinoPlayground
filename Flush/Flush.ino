// ----------------------------------------------------------------------------------------------------
//
// NOTE: Most code herein written by Primo (with some guidance by RocketRedNeck, mainly in the
// area of "what is a state machine" and a little discipline on dimensional units)
// Inspiration by Secondo.
//
// ----------------------------------------------------------------------------------------------------
// Copyright (c) 2013 - RocketRedNeck.net
// RocketRedNeck (and Primo) hereby grants license for others to copy and modify this source code for
// whatever purpose other's deem worthy as long as RocketRedNeck (and Primo) is given credit where
// where credit is due and you leave RocketRedNeck (and Primo) out of it for all other nefarious purposes.
/********************************************************
Flush
...
by Primo (with guidance from RocketRedNeck)
