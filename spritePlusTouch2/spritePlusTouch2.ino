...
void loop() 
{
  drawSpriteCostume(ICON_NAME, gp.x, gp.y, CR(0,5,SCALE)); //72,  40, 94,  64, SCALE, SCALE);  // 1
  drawSpriteCostume(ICON_NAME, gp.x, gp.y, CR(1,5,SCALE)); //7,  40, 118, 64, SCALE, SCALE);  // 2
  drawSpriteCostume(ICON_NAME, gp.x, gp.y, CR(2,5,SCALE)); //121, 40, 143, 64, SCALE, SCALE);  // 3
  drawSpriteCostume(ICON_NAME, gp.x, gp.y, CR(1,5,SCALE)); //97,  40, 118, 64, SCALE, SCALE);  // 2
}
