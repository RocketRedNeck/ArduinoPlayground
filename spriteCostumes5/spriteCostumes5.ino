...
#define ICON_NAME "devil.bmp"
#define FILL_COLOR ILI9341_ORANGE
#define SCALE 3
...
void loop() 
{
  drawSpriteCostume(ICON_NAME, 10, 10, 72, 40, 94, 64, SCALE, SCALE);   // 1
  drawSpriteCostume(ICON_NAME, 10, 10, 97, 40, 118, 64, SCALE, SCALE);  // 2
  drawSpriteCostume(ICON_NAME, 10, 10, 121, 40, 143, 64, SCALE, SCALE); // 3
  drawSpriteCostume(ICON_NAME, 10, 10, 97, 40, 118, 64, SCALE, SCALE);  // 2
}
