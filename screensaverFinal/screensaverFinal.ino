...
void loop() 
{
  ...
  uint16_t h = bmpHeight * STRETCH_FACTOR;
  uint16_t w = bmpWidth * STRETCH_FACTOR;
  ...
  bmpDraw(ICON_NAME, xPos, yPos, STRETCH_FACTOR, STRETCH_FACTOR);
